# genpark-agentic-hallucination-grounding-checker-skill
...
**genpark-agentic-hallucination-grounding-checker-skill** is a deterministic, zero-dependency Python skill engineered with 100% production-grade functional parity for autonomous agent workflows, speculative decoding, and commercial arbitration.

> **Executive Capability**: Sentence-level RAG factual grounding and hallucination detection engine
...
result = client.verify_grounding_claims()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-agentic-hallucination-grounding-checker-skill": {
      "command": "python",
      "args": ["/path/to/genpark-agentic-hallucination-grounding-checker-skill/mcp_server.py"]
    }
  }
}
```
